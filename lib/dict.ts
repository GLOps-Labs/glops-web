...
export const dict = {
  es: {
    ...
    wizard: {
      ...
      email: "Email",
      summary: "Tu pedido",
      scheduleNote: "Agendar abre el calendario con tu pedido ya cargado en Notas. Revísalo antes de confirmar.",
    },
  ...
  en: {
    ...
    wizard: {
      ...
      scheduleNote: "Schedule opens the calendar with your request prefilled in Notes. Review it before confirming.",
    },
